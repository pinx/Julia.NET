...
namespace JuliaNET.Utils
{
    ...
    public class SharpReflect
    {
        ...
        public static MethodInfo GetMethod<T>(string methodName,
                                              params Type[] types) => typeof(T).GetMethod(methodName, FLAGS, null, types, null);
        ...
        public static MethodInfo GetMethod(Type t,
                                           string methodName,
                                           params Type[] types) => t.GetMethod(methodName, FLAGS, null, types, null);
        ...
        public static ConstructorInfo GetConstructor(Type t,
                                                     params Type[] types) => t.GetConstructor(FLAGS, null, types, null);
        ...
        public static FieldInfo GetField(Type t,
                                         string name) => t.GetField(name, FLAGS);
    }
}
