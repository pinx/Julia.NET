...
namespace JuliaNET.Statics
{
    public partial class JuliaStaticLibrary
    {
        ...
        private static readonly MethodInfo JuliaEvalMI =
            SharpReflect.GetMethod<Core.Julia, string>("Eval");
        ...
        public void Generate(string libPath)
        {
            ...
            mb.Create();
            new AssemblyGenerator().GenerateAssembly(asm, libPath);
        }
        ...
        private static void DecorateWithDefAttribute(TypeBuilder tb,
                                                     ConstructorInfo ci)
        {
        ...
        private void LoadUniversalConstant(IlExprBuilder eb,
                                           int idx)
        {
        ...
        private void LoadSymbol(IlExprBuilder eb,
                                string symbol) => LoadUniversalConstant(eb, ":" + symbol);

        private bool ConvertJuliaName(string s,
                                      out string v)
        {
